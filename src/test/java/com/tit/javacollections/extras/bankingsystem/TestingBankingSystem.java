package com.tit.javacollections.extras.bankingsystem;
...
public class TestingBankingSystem {
    ...
    void testBankingSystem() {
        ...
        assertEquals(expectedAccountsSortedByBalance, expectedAccountsSortedByBalance);
