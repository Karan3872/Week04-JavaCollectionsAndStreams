package com.tit.javacollections.mapinterface.wordfrequencycounter;
...
public class WordFrequency {
    public static void main(String[] args) {
        String filePath = "src/main/java/com/tit/javacollections/mapinterface/wordfrequencycounter/text_file.txt";
